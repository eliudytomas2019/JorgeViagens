...
<div class="row">
    &nbsp;&nbsp;<a href="__admin.php?exe=pricing/create&lang=<?= $language; ?>" class="btn btn-primary"><?php
        if($language == "pt"):
            echo "Criar Novo";
        elseif($language == "fr"):
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive p-0">
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tr>
                        <th>ID</th>
                        <th><?php if($language == "pt"):echo "Plano";elseif($language == "fr"):echo "Plat";else:echo "Flat";endif; ?></th>
                        <th><?php if($language == "pt"):echo "Preço";elseif($language == "fr"):echo "Prix";else:echo "Price";endif; ?></th>
                        <th><?php if($language == "pt"):echo "Moeda";elseif($language == "fr"):echo "Pièce de monnaie";else:echo "Coin";endif; ?></th>
                        <th>-</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    $Pager = new Pager("__admin.php?exe=faqs/index&lang={$language}&page=");
                    ...
                    if($Read->getResult()):
                        foreach ($Read->getResult() as $key):
                            ...
                            <tr>
                                ...
                                <td><?= $key['moeda']; ?></td>
                                <td>
                                    <a href="__admin.php?exe=pricing/update&postId=<?= $key['id']; ?>&lang=<?= $language; ?>" class="btn btn-primary"><?php if($language == "pt"):echo "Editar";elseif($language == "fr"):echo "Éditer";else:echo "Edit";endif; ?></a>
                                    <a href="__admin.php?exe=pricing/index&postId=<?= $key['id']; ?>&action=status&lang=<?= $language; ?>" class="btn btn-warning"><?php if($language == "pt"):echo "Suspender";elseif($language == "fr"):echo "Suspendre";else:echo "Suspend";endif; ?></a>
                                    <a href="__admin.php?exe=pricing/index&postId=<?= $key['id']; ?>&action=delete&lang=<?= $language; ?>" class="btn btn-danger"><?php if($language == "pt"):echo "Apagar";elseif($language == "fr"):echo "Éteindre";else:echo "Delete";endif; ?></a>
                                </td>
                            </tr>
                        <?php
                        endforeach;
