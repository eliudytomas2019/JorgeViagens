...
<div class="row">
    &nbsp;&nbsp;<a href="__admin.php?exe=numbers/create&lang=<?= $language; ?>" class="btn btn-primary"><?php
        if($language == "pt"):
            echo "Criar Novo";
        elseif($language == "fr"):
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive p-0">
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tr>
                        <th>ID</th>
                        <th><?php if($language == "pt"):echo "Número";elseif($language == "fr"):echo "Nombre";else:echo "Number";endif; ?></th>
                        <th><?php if($language == "pt"):echo "Número";elseif($language == "fr"):echo "Nombre";else:echo "Number";endif; ?></th>
                        <th><?php if($language == "pt"):echo "Número";elseif($language == "fr"):echo "Nombre";else:echo "Number";endif; ?></th>
                        <th><?php if($language == "pt"):echo "Número";elseif($language == "fr"):echo "Nombre";else:echo "Number";endif; ?></th>
                        <th>-</th>
                    ...
                    $Pager = new Pager("__admin.php?exe=numbers/index&lang={$language}&page=");
                    ...
                    if($Read->getResult()):
                        foreach ($Read->getResult() as $key):
                            ...
                            <tr>
                                ...
                                <td><?= $key['number_4']; ?></td>
                                <td>
                                    <a href="__admin.php?exe=numbers/update&postId=<?= $key['id']; ?>&lang=<?= $language; ?>" class="btn btn-primary"><?php if($language == "pt"):echo "Editar";elseif($language == "fr"):echo "Éditer";else:echo "Edit";endif; ?></a>
                                    <a href="__admin.php?exe=numbers/index&postId=<?= $key['id']; ?>&action=status&lang=<?= $language; ?>" class="btn btn-warning"><?php if($language == "pt"):echo "Suspender";elseif($language == "fr"):echo "Suspendre";else:echo "Suspend";endif; ?></a>
                                    <a href="__admin.php?exe=numbers/index&postId=<?= $key['id']; ?>&action=delete&lang=<?= $language; ?>" class="btn btn-danger"><?php if($language == "pt"):echo "Apagar";elseif($language == "fr"):echo "Éteindre";else:echo "Delete";endif; ?></a>
                                </td>
                            </tr>
                        <?php
                        endforeach;
