...
<div class="row">
    &nbsp;&nbsp;<a href="__admin.php?exe=faqs/create&lang=<?= $language; ?>" class="btn btn-primary"><?php
        if($language == "pt"):
            echo "Criar Novo";
        elseif($language == "fr"):
            ...
            <div class="card-body table-responsive p-0">
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tr>
                        ...
                        <th><?php if($language == "pt"):echo "Descrição";elseif($language == "fr"):echo "Description";else:echo "Content";endif; ?></th>
                        <th>-</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    if($Read->getResult()):
                        foreach ($Read->getResult() as $key):
                            ...
                            <tr>
                                ...
                                <td><?= $key['content']; ?></td>
                                <td>
                                    <a href="__admin.php?exe=faqs/update&postId=<?= $key['id']; ?>&lang=<?= $language; ?>" class="btn btn-primary"><?php if($language == "pt"):echo "Editar";elseif($language == "fr"):echo "Éditer";else:echo "Edit";endif; ?></a>
                                    <a href="__admin.php?exe=faqs/index&postId=<?= $key['id']; ?>&action=status&lang=<?= $language; ?>" class="btn btn-warning"><?php if($language == "pt"):echo "Suspender";elseif($language == "fr"):echo "Suspendre";else:echo "Suspend";endif; ?></a>
                                    <a href="__admin.php?exe=faqs/index&postId=<?= $key['id']; ?>&action=delete&lang=<?= $language; ?>" class="btn btn-danger"><?php if($language == "pt"):echo "Apagar";elseif($language == "fr"):echo "Éteindre";else:echo "Delete";endif; ?></a>
                                </td>
                            </tr>
                        <?php
                        endforeach;
