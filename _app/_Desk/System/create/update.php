<?php
if ($language == "pt"):
    $page = "Atualizar Registro | {$Ass['name']}";
elseif ($language == "en"):
    $page = "Update Registry | {$Ass['name']}";
else:
    $page = "Mettre à jour le registre | {$Ass['name']}";
endif;
...
<div class="card card-default">
    <div class="card-header">
        <h3 class="card-title"><?php
            ...
            elseif($language == "fr"):
                echo "Mettre à jour le registre";
            else:
    ...
    <div class="card-body">
        <div class="row">
            ...
            if ($ClienteData && $ClienteData['SendPostFormL']):
                ...
                $Business->UpdateAllInOne($ClienteData, $file_one, $postId, $language);
                ...
                $Read = new Read();
                $Read->ExeRead("xp_create_all_in_one", "WHERE id=:i ", "i={$postId}");
